...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('athlete_pr_effort'))
        obj.athletePrEffort = SummaryPRSegmentEffort.constructFromObject(data['athlete_pr_effort']);
      if (data.hasOwnProperty('athlete_segment_stats'))
        obj.athleteSegmentStats = SummarySegmentEffort.constructFromObject(data['athlete_segment_stats']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/SummaryPRSegmentEffort} athletePrEffort
   */
  exports.prototype.athletePrEffort = undefined;

  /**
   * @member {module:model/SummarySegmentEffort} athleteSegmentStats
   */
