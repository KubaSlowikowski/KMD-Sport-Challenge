...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActivityType', 'model/DetailedSegmentEffort', 'model/Lap', 'model/LatLng', 'model/MetaAthlete', 'model/PhotosSummary', 'model/PolylineMap', 'model/Split', 'model/SportType', 'model/SummaryActivity', 'model/SummaryGear'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ActivityType'), require('./DetailedSegmentEffort'), require('./Lap'), require('./LatLng'), require('./MetaAthlete'), require('./PhotosSummary'), require('./PolylineMap'), require('./Split'), require('./SportType'), require('./SummaryActivity'), require('./SummaryGear'));
  } else {
    // Browser globals (root is window)
    if (!root.StravaApiV3) {
      root.StravaApiV3 = {};
    }
    root.StravaApiV3.DetailedActivity = factory(root.StravaApiV3.ApiClient, root.StravaApiV3.ActivityType, root.StravaApiV3.DetailedSegmentEffort, root.StravaApiV3.Lap, root.StravaApiV3.LatLng, root.StravaApiV3.MetaAthlete, root.StravaApiV3.PhotosSummary, root.StravaApiV3.PolylineMap, root.StravaApiV3.Split, root.StravaApiV3.SportType, root.StravaApiV3.SummaryActivity, root.StravaApiV3.SummaryGear);
  }
}(this, function(ApiClient, ActivityType, DetailedSegmentEffort, Lap, LatLng, MetaAthlete, PhotosSummary, PolylineMap, Split, SportType, SummaryActivity, SummaryGear) {
  'use strict';
