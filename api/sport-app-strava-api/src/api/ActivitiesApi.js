...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.type Type of activity. For example - Run, Ride etc.
     ...
     */
    this.createActivity = function(name, sportType, startDateLocal, elapsedTime, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      if (sportType === undefined || sportType === null) {
        throw new Error("Missing the required parameter 'sportType' when calling createActivity");
      }
     ...
     * @param {Number} id The identifier of the activity.
     * @param {Object} opts Optional parameters
     * @param {Number} opts.page Deprecated. Prefer to use after_cursor.
     * @param {Number} opts.perPage Deprecated. Prefer to use page_size. (default to 30)
     * @param {Number} opts.pageSize Number of items per page. Defaults to 30. (default to 30)
     * @param {String} opts.afterCursor Cursor of the last item in the previous page of results, used to request the subsequent page of results.  When omitted, the first page of results is fetched.
