...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClubActivity', 'model/ClubAthlete', 'model/DetailedClub', 'model/Fault', 'model/SummaryAthlete', 'model/SummaryClub'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ClubActivity'), require('../model/ClubAthlete'), require('../model/DetailedClub'), require('../model/Fault'), require('../model/SummaryAthlete'), require('../model/SummaryClub'));
  } else {
    // Browser globals (root is window)
    if (!root.StravaApiV3) {
      root.StravaApiV3 = {};
    }
    root.StravaApiV3.ClubsApi = factory(root.StravaApiV3.ApiClient, root.StravaApiV3.ClubActivity, root.StravaApiV3.ClubAthlete, root.StravaApiV3.DetailedClub, root.StravaApiV3.Fault, root.StravaApiV3.SummaryAthlete, root.StravaApiV3.SummaryClub);
  }
}(this, function(ApiClient, ClubActivity, ClubAthlete, DetailedClub, Fault, SummaryAthlete, SummaryClub) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<module:model/ClubActivity>} data The data returned by the service call.
     ...
     * data is of type: {@link Array.<module:model/ClubActivity>}
     */
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ClubAthlete>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/ClubAthlete>}
     */
