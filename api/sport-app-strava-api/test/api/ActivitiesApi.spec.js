    ...
    describe('ActivitiesApi', function() {
      describe('createActivity', function() {
        it('should call createActivity successfully', function(done) {
          ...
          var sportType = "sportType_example";
          ...
          instance.createActivity(name, sportType, startDateLocal, elapsedTime, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            expect(data.calories).to.be(0.0);
            {
              ...
              for (let p in dataCtr) {
                ...
                expect(data.segment).to.be.a(StravaApiV3.SummarySegment);
                  ...
                  expect(data.segment.athletePrEffort).to.be.a(StravaApiV3.SummaryPRSegmentEffort);
                        expect(data.segment.athletePrEffort.prActivityId).to.be.a('number');
                    expect(data.segment.athletePrEffort.prActivityId).to.be("0");
                    expect(data.segment.athletePrEffort.prElapsedTime).to.be.a('number');
                    expect(data.segment.athletePrEffort.prElapsedTime).to.be(0);
                    expect(data.segment.athletePrEffort.prDate).to.be.a(Date);
                    expect(data.segment.athletePrEffort.prDate).to.be(new Date());
                    expect(data.segment.athletePrEffort.effortCount).to.be.a('number');
                    expect(data.segment.athletePrEffort.effortCount).to.be(0);
                  expect(data.segment.athleteSegmentStats).to.be.a(StravaApiV3.SummarySegmentEffort);
                        expect(data.segment.athleteSegmentStats.id).to.be.a('number');
                    expect(data.segment.athleteSegmentStats.id).to.be("0");
                    expect(data.segment.athleteSegmentStats.activityId).to.be.a('number');
                    expect(data.segment.athleteSegmentStats.activityId).to.be("0");
                    expect(data.segment.athleteSegmentStats.elapsedTime).to.be.a('number');
                    expect(data.segment.athleteSegmentStats.elapsedTime).to.be(0);
                    expect(data.segment.athleteSegmentStats.startDate).to.be.a(Date);
                    expect(data.segment.athleteSegmentStats.startDate).to.be(new Date());
                    expect(data.segment.athleteSegmentStats.startDateLocal).to.be.a(Date);
                    expect(data.segment.athleteSegmentStats.startDateLocal).to.be(new Date());
                    expect(data.segment.athleteSegmentStats.distance).to.be.a('number');
                    expect(data.segment.athleteSegmentStats.distance).to.be(0.0);
                    expect(data.segment.athleteSegmentStats.isKom).to.be.a('boolean');
                    expect(data.segment.athleteSegmentStats.isKom).to.be(false);
      ...
      describe('getCommentsByActivityId', function() {
        it('should call getCommentsByActivityId successfully', function(done) {
          ...
          opts.perPage = 30;
          opts.pageSize = 30;
          opts.afterCursor = "afterCursor_example";
      ...
      describe('updateActivityById', function() {
        it('should call updateActivityById successfully', function(done) {
          ...
          opts.body.sportType = new StravaApiV3.SportType();
          opts.body.gearId = "";
