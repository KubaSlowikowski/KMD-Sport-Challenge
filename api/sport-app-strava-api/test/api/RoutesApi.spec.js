          ...
          instance.getRouteById(id, function(error, data, response) {
            ...
            expect(data.estimatedMovingTime).to.be(0);
            {
              ...
              for (let p in dataCtr) {
                ...
                expect(data._private).to.be.a('boolean');
                expect(data._private).to.be(false);
                expect(data.athletePrEffort).to.be.a(StravaApiV3.SummaryPRSegmentEffort);
                      expect(data.athletePrEffort.prActivityId).to.be.a('number');
                  expect(data.athletePrEffort.prActivityId).to.be("0");
                  expect(data.athletePrEffort.prElapsedTime).to.be.a('number');
                  expect(data.athletePrEffort.prElapsedTime).to.be(0);
                  expect(data.athletePrEffort.prDate).to.be.a(Date);
                  expect(data.athletePrEffort.prDate).to.be(new Date());
                  expect(data.athletePrEffort.effortCount).to.be.a('number');
                  expect(data.athletePrEffort.effortCount).to.be(0);
                expect(data.athleteSegmentStats).to.be.a(StravaApiV3.SummarySegmentEffort);
                      expect(data.athleteSegmentStats.id).to.be.a('number');
                  expect(data.athleteSegmentStats.id).to.be("0");
                  expect(data.athleteSegmentStats.activityId).to.be.a('number');
                  expect(data.athleteSegmentStats.activityId).to.be("0");
                  expect(data.athleteSegmentStats.elapsedTime).to.be.a('number');
                  expect(data.athleteSegmentStats.elapsedTime).to.be(0);
                  expect(data.athleteSegmentStats.startDate).to.be.a(Date);
                  expect(data.athleteSegmentStats.startDate).to.be(new Date());
                  expect(data.athleteSegmentStats.startDateLocal).to.be.a(Date);
                  expect(data.athleteSegmentStats.startDateLocal).to.be(new Date());
                  expect(data.athleteSegmentStats.distance).to.be.a('number');
                  expect(data.athleteSegmentStats.distance).to.be(0.0);
                  expect(data.athleteSegmentStats.isKom).to.be.a('boolean');
                  expect(data.athleteSegmentStats.isKom).to.be(false);
